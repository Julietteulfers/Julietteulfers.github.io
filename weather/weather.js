...
$.getJSON(weatherAlertsUrl, function(data) {
  ...
  if (feature.properties.severity === 'Severe') alertColor = 'red',(feature.properties.severity === 'Extreme') alertColor = 'purple',(feature.properties.severity === 'Minor') alertColor = 'green';
